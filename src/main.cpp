...
/* SPACESHIPS	*/
	...
	osg::ref_ptr<osg::Node> xWing (osgDB::readNodeFile("/home/user/Documents/MEDEV/TP-Avions/star-wars-x-wing/star wars x-wing.3ds"));
	osg::ref_ptr<osg::Node> tFighter (osgDB::readNodeFile("/home/user/Documents/MEDEV/TP-Avions/TIEFIGHTER/TF_3DS02.3ds"));
